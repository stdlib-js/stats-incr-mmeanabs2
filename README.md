...
```javascript
import incrmmeanabs2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mmeanabs2@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-mmeanabs2/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-incr-mmeanabs2/actions/workflows/test.yml?query=branch:v0.2.2
